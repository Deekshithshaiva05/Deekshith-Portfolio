...
const BlogFooter: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Deekshithshaiva05', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/deekshith-n-036ab9263', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:deekshithshaiva05@gmail.com', label: 'Email' },
    { icon: Facebook, href: 'https://facebook.com/deekshithshaiva05', label: 'Facebook' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold text-primary-400 mb-4">TechBlog</h3>
            <p className="text-gray-400 mb-4">
              Sharing insights about AI, Machine Learning, Web Development, and Technology.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} TechBlog by Deekshith N. All rights reserved.
          </p>
