...
export const projects: Project[] = [
  ...
  "featured": true,
  "details": "InnovByte AI is a real-time web application that automatically reviews, enhances, and structures prompts before they are processed by large language models. Developed during a 24-hour hackathon at MITM Mysore by Team InnovByte (Deekshith N, Vinay S Dhakshath UK, and Prajwal M), it acts as a preprocessing safety and quality assurance layer for LLM inputs.\n\nThe system validates grammar, detects unsafe or confidential content, checks for completeness, and then categorizes each prompt into one of three outcomes: BLOCK, NEEDS_FIX, or ALLOW. For prompts requiring enhancement, the system returns an improved version enriched with structured metadata using the COSTAR or ISTVON frameworks — ensuring better LLM comprehension and output consistency.\n\n⚙️ **Key Features**\n- **Multi-input support:** Accepts both text and voice inputs (Speech-to-Text integration).\n- **Grammar & readability check:** Automatically detects and fixes grammatical or structural issues.\n- **Safety & confidentiality filter:** Identifies illegal, sensitive, or disallowed content and blocks it securely.\n- **Classification outcomes:**\n  - BLOCK → Unsafe or prohibited prompt.\n  - NEEDS_FIX → Incomplete or unclear prompt; returns improved version.\n  - ALLOW → Safe and complete prompt; proceeds to processing.\n- **COSTAR / ISTVON enrichment:** Generates structured JSON prompts with context, objectives, tone, and deliverables.\n- **Multi-LLM dispatch:** Supports sending enhanced prompts to multiple backend models (OpenAI, Gemini, Ollama, DeepSeek, ESC, etc.).\n- **Copy & paste JSON:** Allows easy export of structured prompts into other AI systems.\n\n🧠 **How It Works**\n1. User enters a text or voice prompt.\n2. Grammar and style are automatically corrected.\n3. Safety scanner flags any disallowed content.\n4. If incomplete, system enhances it (NEEDS_FIX).\n5. Safe prompts are approved (ALLOW).\n6. Generates structured COSTAR/ISTVON JSON.\n7. User chooses target LLM backend for execution.\n\n📘 **COSTAR Schema**\nProvides structure for clarity and precision in AI prompts:\n- **C:** Context — Relevant background information.\n- **O:** Objective — Task or goal.\n- **S:** Style — Desired communication style.\n- **T:** Tone — Emotional tone (formal, friendly, persuasive, etc.).\n- **A:** Audience — Intended reader or user.\n- **R:** Response — Format, constraints, and structure.\n\n🧩 **ISTVON Framework**\nUsed to automate prompt workflows with structured AI orchestration:\n- **I:** Instructions — Role, goal, and format of the task.\n- **S:** Source Data — Relevant knowledge base or external data.\n- **T:** Tools — APIs or models to use.\n- **V:** Variables — Filters, constraints, and quality rules.\n- **O:** Outcome — Expected deliverables and format.\n- **N:** Notification — Reporting and alerting mechanism.\n\n🚀 **Advantages**\n- Enhances LLM performance with structured, context-aware prompts.\n- Prevents unsafe or confidential content from being processed.\n- Ensures interoperability across multiple LLMs.\n- Reduces hallucinations by enforcing contextual clarity.\n- Enables real-time multi-LLM switching and comparison.\n\n🔧 **Supported Backends**\n- Rule-based engine (lightweight fallback)\n- OpenAI\n- Gemini\n- Ollama\n- DeepSeek\n- ESC (local/experimental)\n\n📈 **Future Roadmap**\n- Context-aware safety classifier with adaptive learning.\n- Enterprise-level blocklist customization.\n- Analytics dashboard for prompt usage and failure tracking.\n- One-click API integrations with major LLM providers.\n- Team management, access control, and audit trails.\n\n🏆 **Project Info**\n- Built during a **24-hour hackathon** at **MITM Mysore**.\n- **Team Members:** Deekshith N · Vinay S Dhakshath UK · Prajwal M.\n- Focused on **safe, interpretable, and structured AI prompt engineering** for multi-agent and enterprise applications."
  },
  {
